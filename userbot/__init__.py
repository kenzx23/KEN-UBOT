...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/kenzx23/KEN-UBOT.git")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/9cf8933ad10f520fc72e2.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "**☛KEN-UBOT☚ SUDAH AKTIF YA GOBLOK!!!**")
    return
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("KEN-UBOT, Buat Userbot Mu Sendiri [Tekan Disini](https://github.com/Zora24/Lord-Userbot.git)")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    "**KEN✗UBOT**",
                    text="""**Anda Bisa Membuat KEN-UBOT Anda Sendiri Dengan Cara:** [Tekan Disini](t.me/xpeeps)""",
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo KEN-UBOT",
                                "https://github.com/kenzx23/KEN-UBOT"),
                            custom.Button.url(
                                "Pemilik Repo",
                                "t.me/xgothboi")],
                    ],
